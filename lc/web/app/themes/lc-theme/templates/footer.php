  ...
  <div class="container white">
  	<div class="row">
	    ...
	    <div class="col-md-2">
	    	...
	    	<ul>
	    		<li><a href="/credit-cards">Credit Cards</a></li>
					...
					<li><a href="/participating-banks">Participating Banks</a></li>
					<li><a href="/join-our-network">Join Our Network</a></li>
	    	</ul>
	    </div>
	    <div class="col-md-2">
	    ...
	    <div class="col-md-2">
	    	...
	    	<ul>
	    		<li><a href="/priacy-policy">Privacy Policy</a></li>
	    	...
	    	<div class="bkgd-medium round5 tac p20 footer-join">
		    	...
		    	<ul>
		    		<li>Reach a targeted local audience</li>
						<li>Advertise your best selling products</li>
						<li>Monthly analytics reports</li>
						<li>Easy monthly pricing structure</li>
		    	</ul>
		    	<a class="btn btn-primary" href="join-our-network">More Info</a>
	    	</div>
	    </div>
    </div>
    <div class="row footer-mission">
    	<div class="col-md-9">
   			<p>Our mission is to help people of all ages and backgrounds connect with local banks and credit unions in order to forge lasting financial relationships that help communities prosper. Please note: Local.Credit is a marketing lead generator and is not a bank. </p>
    	</div>
    </div>
  </div>
</footer>
